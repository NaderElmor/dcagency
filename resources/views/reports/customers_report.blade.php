                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="Section" class="form-control select2" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option value="{{ $selected_section->id ?? 'حدد القسم ' }}" selected disabled>{{$selected_section->name ?? 'حدد القسم'}}</option>
                            ...
                            <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                ...
                                <select id="product" name="product" class="form-control select2">
                                    <option value="{{ $section_id ?? 'حدد المنتج ' }}" selected disabled>{{$section_name ?? 'حدد القسم'}}</option>
    ...
    <script>
        $(document).ready(function() {
            $('select[name="Section"]').on('change', function() {
                ...
                if (SectionId) {
                    $.ajax({
                        url: "{{ URL::to('invoices/create/section-products') }}/" + SectionId,
                        type: "GET",
                        dataType: "json",
